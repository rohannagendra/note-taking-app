...
import { getComments, addComment, deleteComment } from '../lib/blocks.js';
...
export default function BlockComments({ blockId, onClose, onCountChange }) {
  ...
  const handleSubmit = async () => {
    ...
    setInput('');
    try {
      const newComment = await addComment(blockId, text);
  ...
  return (
    <div className="block-comments-panel">
      <div className="block-comments-header">
        <span className="block-comments-title">Comments</span>
